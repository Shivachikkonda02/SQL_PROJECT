...
-- 6.Jin the neccessary tables to find the total quantity of each pizza category ordered.
...
-- 9.Group the orders by date and calcualte the average number of pizzas ordered per day
...
-- 12. Analyze the cumulative revenge generated over time.
